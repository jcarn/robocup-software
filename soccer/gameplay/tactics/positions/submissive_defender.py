...
class SubmissiveDefender(
    ...
    def block_line(self, value):
        ...
        arc_left = robocup.Arc(
            ...
            constants.Field.ArcRadius + constants.Robot.Radius * 2, math.pi /
            2, math.pi)
        arc_right = robocup.Arc(
            robocup.Point(constants.Field.GoalFlat / 2, 0),
            constants.Field.ArcRadius + constants.Robot.Radius * 2, 0, math.pi
            / 2)
        seg = robocup.Segment(
            robocup.Point(
    ...
    def execute_marking(self):
        ...
        if move.pos != None:
            ...
            main.system_state().draw_segment(
                seg.get_pt(0), seg.get_pt(1), constants.Colors.Green, "Mark")
